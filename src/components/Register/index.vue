<template>
    <div class="register_body">
        <div class="register_email">
            邮箱: <input v-model="email" type="text" class="register_text"> <button :disabled="disabled" @touchstart="handleToVerify">{{ verifyInfo }}</button>
        </div>
        <div>
...
.register_email button {position: absolute;right: 10px;height: 30px;border-radius: 3px; border:none;padding: 5px}
